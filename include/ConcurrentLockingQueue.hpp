...
* @brief The class ConcurrentLockingQueue is a queue that can be accessed concurrently.
* @details The class is based on a std::queue and extends this class with locking mechanisms.
*/
template <class Type>
class ConcurrentLockingQueue
{
